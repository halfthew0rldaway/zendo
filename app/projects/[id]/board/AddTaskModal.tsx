    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            className="p-1 hover:bg-[#e3e9ec] rounded-full transition-colors"
            onClick={onClose}
          >
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            />
            {error && (
              <p className="text-xs text-[#9f403d] mt-1">{error}</p>
            )}
          </div>
          ...
          <div>
            <label className="text-xs font-semibold text-[#586064] block mb-2">
              Labels
            </label>
                ...
                return (
                  <button
                    ...
                    className={`px-2.5 py-1 rounded text-[10px] font-bold transition-all ${
                      selected
                        ? "bg-[#0c56d0] text-white"
                        : "bg-[#e3e9ec] text-[#586064] hover:bg-[#dbe4e7]"
                    }`}
